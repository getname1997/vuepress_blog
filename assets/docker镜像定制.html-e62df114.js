import{_ as n,o as e,c as s,e as i}from"./app-a3b4d25a.js";const a={},l=i(`<h1 id="docker-镜像定制" tabindex="-1"><a class="header-anchor" href="#docker-镜像定制" aria-hidden="true">#</a> docker 镜像定制</h1><h2 id="项目目录新建-dockerfile-文件" tabindex="-1"><a class="header-anchor" href="#项目目录新建-dockerfile-文件" aria-hidden="true">#</a> 项目目录新建 Dockerfile 文件</h2><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code><span class="token comment"># Use an official Node.js runtime as the base image</span>
